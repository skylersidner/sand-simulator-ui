...
function DisclaimerModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <ModalOverlay />
      <ModalContent w={["100%", 600, 800]}>
        <ModalHeader>Modal Title</ModalHeader>
        <ModalCloseButton />
        <ModalBody>
          <h1>Disclaimer</h1>
          <p>Last updated: January 02, 2023</p>
          ...
          <ul>
            <li>
              ...
              in this Disclaimer) refers to Happier Me.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Happier Me, accessible from{" "}
              <a
                href="https://happierme.xyz"
          ...
          <ul>
            <li>
              ...
              <a
                href="https://happierme.xyz/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://happierme.xyz/contact
              </a>
            </li>
          </ul>
        </ModalBody>
